...
(function($, window, document) {
    ...
    var version = "3.2.31"; // Version of this copy of the script
    ...
    $.fn.LiveAddress = function(arg) {
        ...
        config.overrideValues = config.overrideValues !== false ? true : defaults.overrideValues;
    ...
    function Address(domMap, formObj, addressID, match) {
        ...
        this.overrideValues = function() {
            ...
            if (fields.country) {
                fields.country.value = $(fields.country.dom).find(":selected").text();
            }

            if (fields.address1) {
                fields.address1.value = $(fields.address1.dom).val();
            }

            if (fields.address2) {
                fields.address2.value = $(fields.address2.dom).val();
            }

            if (fields.postal_code) {
                fields.postal_code.value = $(fields.postal_code.dom).val();
            }

            if (fields.locality) {
                fields.locality.value = $(fields.locality.dom).val();
            }
        }
...
//# sourceURL=jquery.liveaddress.js
